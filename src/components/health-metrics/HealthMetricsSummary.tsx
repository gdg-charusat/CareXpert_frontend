              ...
              {metricsArray.map((metric) => (
                <div
                  ...
                  className={cn(
                    ...
                    metric.status === 'CRITICAL' && "border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950/20",
                    metric.status === 'ABNORMAL' && "border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/20",
                    metric.status === 'NORMAL' && "border-border bg-muted/50"
                  )}
                >
                  <div className="flex items-start justify-between">
                    ...
                    <Badge
                      variant="secondary"
                      className={cn("text-xs", STATUS_COLORS[metric.status])}
                    >
                      {metric.status}
                    </Badge>
                  </div>
